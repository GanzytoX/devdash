...
import { LayoutDashboard, Server, BarChart3, Settings, Zap } from 'lucide-react';
    ...
    <aside className="w-20 md:w-64 glass-panel border-r border-y-0 border-l-0 flex flex-col h-screen sticky top-0 shrink-0 z-20">
      ...
      <div className="p-4 md:p-6 border-b border-white/5 flex items-center gap-3 justify-center md:justify-start">
        ...
        <div className="hidden md:block">
          <h1 className="text-lg font-semibold text-slate-100 font-sans tracking-tight m-0 leading-none">DevDash</h1>
          <span className="text-[10px] font-mono text-brand-blue-400 font-bold tracking-wider uppercase">Autohospedado</span>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-white/5 bg-slate-950/20 hidden md:block">
        <div className="rounded-lg p-3 bg-white/5 border border-white/5">
          <div className="flex items-center justify-between text-[11px] font-mono text-slate-400 mb-1">
            <span>Servidor:</span>
            <span className={serverStatus === 'online' ? 'text-emerald-400' : 'text-red-400'}>
