...
export function SettingsPanel() {
  ...
  return <div className="space-y-5 md:space-y-8 animate-fade-in text-xs">
    <section className="glass-panel p-4 sm:p-6 rounded-2xl space-y-5"><h2 className="flex items-center gap-2 font-mono font-bold uppercase"><Settings className="h-4 w-4 text-brand-blue-400" /> Canales de alertas</h2>
